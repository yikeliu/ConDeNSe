function [ MDLcost_fc, MDLcost_nc, MDLcost_fc_perf ] = mdlCostAsfANDnClique( Asmall, N_tot )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

...
function [ ] = BlockModelEncode(AOrig, k, outFolder, info, starOption, minSize, graphFile )
...
% blockmodel encoding
fn = strcat([fname,ext,'.blockmodelpart']);
display(fn);
groups = dlmread(fn);
%display(groups);
...
copyfile('model.mat','../../DATA/BlockModel');

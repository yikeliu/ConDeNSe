function [ MDLcostBC, MDLcostNB, MDLcostBC_perf, set1, set2 ] = mdlCostAsBCorNB( Asmall, N_tot )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% MDL cost of encoding given substructure as a perfect bipartite core
MDLcostBC_perf = compute_encodingCost( 'bc', N_tot, sum(set1), zeros(n,n), sum(set2) );

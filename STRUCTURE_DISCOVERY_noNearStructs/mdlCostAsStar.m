function [ MDLcost, MDLcost_perf, idxMaxDeg, satellitesIdx ] = mdlCostAsStar( Asmall, curind, N_tot )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% MDL cost of encoding given substructure as a perfect star
MDLcost_perf = compute_encodingCost( 'st', N_tot, n, zeros(n,n));

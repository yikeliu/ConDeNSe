function [ MDLcost, MDLcost_perf, chainExt ] = mdlCostAsChain( Asmall, N_tot )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% MDL cost of encoding given substructure as a pefect chain
MDLcost_perf = compute_encodingCost( 'ch', N_tot, n, zeros(n,n));

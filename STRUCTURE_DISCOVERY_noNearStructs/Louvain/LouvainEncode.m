...
function [ ] = LouvainEncode(AOrig, k, outFolder, info, starOption, minSize, graphFile )
...
%    info = false;
%end
[~, fname, filetype] = fileparts(graphFile);
...
copyfile('model.mat','../../DATA/Louvain');
